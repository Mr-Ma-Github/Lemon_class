...
class GetData:
    ...
    NoRegTel = load_workbook(project_path.test_case_path)['init'].cell(2,1).value
    normal_tel = load_workbook(project_path.test_case_path)['init'].cell(3, 1).value
    admin_tel = load_workbook(project_path.test_case_path)['init'].cell(4, 1).value
    loan_member_id = load_workbook(project_path.test_case_path)['init'].cell(5, 1).value
    member_Id = load_workbook(project_path.test_case_path)['init'].cell(6, 1).value
    pwd=123456
    # print(memberId)
