...
# print(project_path)
# 测试数据的路径
test_data_path = os.path.join(project_path, r"test_data\test_data.xlsx")
# print(test_data_path)
# # 测试用例的路径
# test_case_path = os.path.join(project_path, r"test_data\test_data.xlsx")
...
# print(case_log_path)
image_path = os.path.join(project_path,"test_result", "image")
