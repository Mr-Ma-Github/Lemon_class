...
# 拿到该项目所在的绝对路径
path = r'C:\Users\haiyu.ma\PycharmProjects\lemon_class\APIAutomation2021\class_1120\do_excel_learn'
...
if __name__ == '__main__':  # 我们执行该文件测试一下是否可以正确获取Excel中的值
    print(readExcel().get_xls('Excel_study.xlsx', 'python'))